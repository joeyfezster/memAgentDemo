...
See the [self-hosting guide](/guides/selfhosting/index.md) for more information on running Letta with Docker.
...
For Letta Cloud usage, see the [quickstart guide](/quickstart/index.md). Cloud deployments manage embeddings automatically and don’t require provider configuration.
