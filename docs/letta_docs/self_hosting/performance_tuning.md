---
title: Performance tuning | letta-sdk
description: Optimize self-hosted Letta server performance with caching, scaling, and resource management.
---
...
- `LETTA_PG_POOL_RECYCLE`: When to recycle connections (default: `1800`) These configuration are _per worker_.
