---
title: Best practices | letta-sdk
...
If your agent forgets to use archival memory, you should first try prompting the agent to use it more consistently. If prompting alone doesn’t work, you can enforce archival usage with [tool rules](/guides/agents/tool-rules/index.md).
...
await client.agents.update(agent.id, {
  toolRules: [{ type: "init", toolName: "archival_memory_search" }],
});
```
...
[Learn more about tool rules →](/guides/agents/tool-rules/index.md)
