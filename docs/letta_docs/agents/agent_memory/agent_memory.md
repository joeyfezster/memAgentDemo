...
[Learn more about memory blocks →](/guides/agents/memory-blocks/index.md)
...
[Shared Memory Patterns ](/guides/agents/multi-agent-memory/index.md)Use shared memory across multiple agents

[MemGPT Paper ](https://arxiv.org/abs/2310.08560)Read the research behind Letta's memory system
