---
title: Multi-agent shared memory | letta-sdk
description: Share memory between agents with read-only blocks, collaborative editing, and coordination.
---
