---
title: Context engineering | letta-sdk
...
function updateSupervisorBlock(blockLabel: string, newValue: string): void {
  ...
  await client.agents.blocks.modify(agentId, blockLabel, newValue);
}
```
