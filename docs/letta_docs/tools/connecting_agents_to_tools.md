---
title: Connecting agents to tools | letta-sdk
...
- [**Pre-built tools**](/guides/agents/prebuilt-tools/index.md): connect to tools that are built into the Letta server, such as memory management tools and web search / code execution.
...
- [TypeScript {9}](#tab-panel-425)
- [Python {9}](#tab-panel-426)
...
You can customize the environment that your tool runs in (the Python package dependencies and environment variables) by setting a tool execution environment. See more [here](/guides/agents/tool-variables/index.md).
...
- [TypeScript {9-11}](#tab-panel-423)
- [Python {9-11}](#tab-panel-424)
...
Read more about tool rules [here](/guides/agents/tool-rules/index.md).

## External Tool Libraries

Letta supports connecting to external tool libraries via [MCP](/guides/mcp/overview/index.md). You can connect to MCP servers via the Letta SDK (Python and TypeScript/Node.js) as well as via simple point-and-click in the ADE.
