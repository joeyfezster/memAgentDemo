...
- [x] Backend scaffold (FastAPI) — FastAPI app with health check, pytest suite, pip + Alembic.
- [x] Frontend scaffold (React + Vite + TypeScript) — Login placeholder UI, Vitest + Testing Library.
- [x] Infrastructure tooling (docker-compose) — Compose stack for backend, frontend, Postgres.
